---
title: "Perceptions and Preferences for Meritocracy in Survey Research"
css: "custom.css"
linestretch: '1.5'
link-citations: yes
# params:
...
- name: Jorge Atria
  ...
  number: 5
abstract: |
  Economic and social inequalities are causing growing concerns and crises in contemporary societies. One factor suggested to explain the persistence of inequality is the belief in meritocracy, which justifies economic disparities based on differences in effort and talent. However, empirical research on meritocracy is relatively new and characterized by diverse conceptualizations and measures, leading to inconsistent findings and interpretations. To address this issue, the present paper proposes a conceptual and measurement framework for perceptions and preferences regarding meritocracy and non-meritocracy, focusing on comparative survey research methodologies. The proposal is first tested through confirmatory factor analysis (CFA) using data from the International Social Survey Programme (ISSP) inequality module, commonly used in comparative research on meritocracy. Based on these findings,  a second study focuses on developing a novel scale that better captures the distinction between perceptions and preferences related to meritocracy. This scale is tested using a sample of 2,141 individuals from Chile. The results of this study contribute to refining the measurement of meritocracy and non-meritocracy and shed light on the importance of considering different dimensions when studying meritocracy in survey research, both conceptually and empirically.
  \newline
  \newline
