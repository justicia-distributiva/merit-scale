---
title: "Analysis Merit Scale - Study 2"
...
```{r}
# this in for use in case it is necessary to produce different tables for pdf and is_html_output
...
This is the code for generating tables and graphs based on the analysis of the of the Perceptions and Preferences for Meritocracy Scale.

# Libraries

```{r}
pacman::p_load(sjPlot, dplyr, lavaan, semPlot, stargazer, corrplot, psych, knitr, kableExtra, rvest, sjlabelled, ggplot2)
source('production/prod_polychoric.R') # for polychoric correlation analysis
```
...
semPaths(
  ...
  filetype = "png",
  filename = "output/images/meas02"
) #arrow size)
# text(2.5, -1, labels = "Hola")
```


```{r meas03-0, eval=FALSE, include=TRUE}
nodeNames <-c("Perception effort","Perception talent","Perception rich family","Perception contacts",
              "Preference effort","Preference talent","Preference rich family","Preference contacts",
