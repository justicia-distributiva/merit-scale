...
```{r echo=FALSE}
 ...
 kable(tab01,format = table_format,booktabs = T, linesep = "",col.names = cnames, caption = tb) %>%
...
![`r diam1`](../input/images/app_mod.png)
...
sumdat04<- kable(table04b, table_format, booktabs= T, escape = FALSE,align = "l",linesep = "", caption = tades
) %>% 
...
![`r liker`](../output/images/plotlikert.png)
...
tb.fm01<- kable(tb.fm, table_format, booktabs = T,linesep = "", escape = FALSE,align = "lcccccccccccc",col.names = tb.col, caption = tb.caption) %>% 
