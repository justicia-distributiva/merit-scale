...
edge.width =1,
         sizeMan=5,
         sizeLat = 10, width = 12,
         height= 15, nodeNames = nodeNames, intercepts = F, reorder = F, thresholds = F, nodeLabels = c("A","B","C","D","E","F","G","H","1","2","3","4"), filetype ="png", filename = "output/images/meas01") #arrow size)
