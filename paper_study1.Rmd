...
p4<-likert_issp %>% 
  ...
  sjPlot::plot_likert(geom.colors = "PuBu",
                      title = "Preference Non-meritocratic",
                        ...
                        reverse.scale = F,
                        show.n = FALSE) +
  ggplot2::labs(caption = paste0("Source: Authors calculation based on International Social Survey Programme - Social Inequality 2009"," (n=",dim(likert_issp)[1],")"))+
  ggplot2::theme(legend.position = "bottom") +
  ggplot2::scale_fill_brewer(breaks=c(5:1),
                             direction = -1,
                             labels = c("Not important at all","Not very important",
                                        "Fairly important","Very important","Essential"))
```
