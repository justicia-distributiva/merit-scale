...
corrplot(cor04$rho,method = "color", type = "upper", tl.col = "black", addCoef.col = "black",diag = TRUE)

png("output/images/corpoly.png",
    width = 15,height = 15,units="cm",
    pointsize=12,bg="white",res=300)

corrplot(cor01$rho,method = "color" ,type = "upper", tl.col = "black", addCoef.col = "black",diag = TRUE)
...
edge.width =1,
         sizeMan=5,
         sizeLat = 10, width = 12,
         height= 15, nodeNames = nodeNames, intercepts = F, reorder = F, thresholds = F, nodeLabels = c("A","B","C","D","E","F","G","H","1","2","3","4"), filetype ="png", filename = "output/images/meas02") #arrow size)
...
save(fit4_o,file = "output/tables/fit4_o.RData")
save(fit3_o,file = "output/tables/fit3_o.RData")
save(fit2_o,file = "output/tables/fit2_o.RData")
save(fit1_o,file = "output/tables/fit1_o.RData")
...
dat_merit_2<- dat_merit %>% sjmisc::rec(rec="rev") %>% select("a.Effort"=a.Effort_r,"a.Talent"=a.Talent_r, "a.Rich Parents"="a.Rich Parents_r", "a.Contacts"=a.Contacts_r, "b.Effort"=b.Effort_r,"b.Talent"=b.Talent_r,"b.Rich Parents"="b.Rich Parents_r", "b.Contacts"=b.Contacts_r)


plotlikert<-plot_likert(dat_merit_2, c(1,1,1,1,2,2,2,2),
            ...
            values  =  "sum.outside", reverse.colors = T)
plotlikert

ggsave(plotlikert,filename = "output/images/plotlikert.png",device = "png",width = 25,height = 15,dpi = "retina",units = "cm")
