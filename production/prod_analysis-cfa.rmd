...
dat_merit <- dat04 %>% select("Effort"=perc_effort,"Talent"=perc_talent, "Rich Parents"=perc_wpart, "Contacts"=perc_netw, "Effort"=pref_effort,"Talent"=pref_talent,"Rich Parents"=pref_wpart, "Contacts"=pref_netw) 
