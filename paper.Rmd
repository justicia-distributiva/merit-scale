...
#dev.copy(png,'output/images/Fig2.plotlikert-study1.png') # save image
...
#dev.copy(png,'output/images/Fig3.plotcor-sutdy1.png') # save image  
...
#dev.copy(png,'output/images/Fig6.plotlikertmerit-scale.png') # save image    
...
#dev.copy(png,'output/images/Fig6.plotcor-sutdy2.png') # save image  
  if (!require("pacman")) install.packages("pacman")
  load(file = "input/data/proc/data_s2.RData")
  pacman::p_load(dplyr, corrplot, lavaan)
